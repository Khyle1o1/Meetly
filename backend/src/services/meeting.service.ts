...
export const createMeetBookingForGuestService = async (
  ...
  if (event.locationType === EventLocationEnumType.GOOGLE_MEET_AND_CALENDAR && meetIntegration) {
  ...
  // For face-to-face meetings, we don't create calendar events or meet links
